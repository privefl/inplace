...
template <int RTYPE>
void substract_mat1_mult(Matrix<RTYPE>& x, const Vector<RTYPE>& val) {
...
template <int RTYPE>
void substract_mat2_mult(Matrix<RTYPE>& x, const Vector<RTYPE>& val) {
