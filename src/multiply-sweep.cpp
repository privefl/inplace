...
template <int RTYPE>
void multiply_mat1_mult(Matrix<RTYPE>& x, const Vector<RTYPE>& val) {
...
template <int RTYPE>
void multiply_mat2_mult(Matrix<RTYPE>& x, const Vector<RTYPE>& val) {
